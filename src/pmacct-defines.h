...
#define PMACCTD_USAGE_HEADER "Promiscuous Mode Accounting Daemon, pmacctd 0.14.3"
#define UACCTD_USAGE_HEADER "Linux NetFilter ULOG Accounting Daemon, pmacctd 0.14.3"
#define PMACCT_USAGE_HEADER "pmacct, pmacct client 0.14.3"
#define PMMYPLAY_USAGE_HEADER "pmmyplay, pmacct MySQL logfile player 0.14.3"
#define PMPGPLAY_USAGE_HEADER "pmpgplay, pmacct PGSQL logfile player 0.14.3"
#define NFACCTD_USAGE_HEADER "NetFlow Accounting Daemon, nfacctd 0.14.3"
#define SFACCTD_USAGE_HEADER "sFlow Accounting Daemon, sfacctd 0.14.3"
